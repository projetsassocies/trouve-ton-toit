      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">
            {editId ? 'Modifier le bien' : 'Nouveau bien'}
          </h1>
          <p className="text-[#999999] text-sm mt-0.5">
            {editId ? 'Modifiez les informations du bien' : 'Ajoutez un nouveau bien à votre catalogue'}
          </p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl border border-[#E5E5E5] p-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
            ...
            <label className={cn(
              ...
              />
              {uploading ? (
                <div className="w-6 h-6 border-2 border-[#CCCCCC] border-t-transparent rounded-full animate-spin" />
              ) : (
                <>
